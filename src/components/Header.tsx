        ...
        <div className='flex justify-center mt-8 space-x-4'>
          ...
          >
            ...
            >
              <path
                fill='currentColor'
                d='M496.222,167.759H359.029c36.38,42.51,44.053,105.076,14.512,156.213L265.047,511.914 c85.156-3.109,166.885-48.57,212.632-127.81C517.191,315.663,521.486,236.558,496.222,167.759z'
              />
            </svg>
          </a>
      </div>
