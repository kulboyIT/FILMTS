...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="#2196F3"
        d="M8.32 7.68L.58 15.42c-.37-.35-.57-.83-.57-1.35V1.93C.01 1.4.22.92.6.56l7.72 7.12z"
      ></path>
      <path
        fill="#FFC107"
      ...
      <path
        fill="#4CAF50"
        d="M8.32 7.68L.6.56C.7.46.83.37.96.29 1.59-.09 2.35-.1 3 .26l8.21 4.53-2.89 2.89z"
      ></path>
      <path
        fill="#F44336"
        d="M11.8 10.89L3 15.74c-.31.18-.66.26-1 .26-.36 0-.72-.09-1.04-.29a1.82 1.82 0 01-.38-.29l7.74-7.74.75.69 2.73 2.52z"
      ></path>
    </svg>
          </a>
           <a
