  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://img.eu13.proxysite.com/process.php?d=tc5NMem0wOHZdoG4fA%3D%3D&b=1&f=norefer/uploads/movies/${dataFilm.item.poster_url}')`
        }}
      />
        ...
        <div className='flex-col md:flex-row flex gap-11 md:gap-[64px]'>
          <div className='flex-shrink-0 flex flex-col items-center'>
            <img
              ...
              src={`https://img.eu13.proxysite.com/process.php?d=tc5NMem0wOHZdoG4fA%3D%3D&b=1&f=norefer/uploads/movies/${dataFilm.item.thumb_url}`}
