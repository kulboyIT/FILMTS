...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Xem phim Online miễn phí - KulFlix </title>
        <meta
          name='description'
          content='Web xem phim online miễn phí lớn nhất được cập nhật liên tục mỗi ngày - Cùng tham gia xem phim và thảo luận với hơn 10 triệu thành viên 🎉 tại KulFlix ❤️💛💚'
        />
      </Helmet>
